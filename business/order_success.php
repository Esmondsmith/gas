...
<div class="carousel-inner">
    ...
    <div class="carousel-item active">
        <div class="carousel-text1">
            ...
            <p id="carousel1" class="p2">"Your Order has been placed"</p>
      ...
      <div class="d-flex">
        <div class="row">
            <div class="col">
            <a href="../index.php">
                <button id="reg_sucess" class="btn btn-lg btn-success">Back to Home</button>
            </a>
            </div>
        </div>
        <div class="row">
            <div class="col">
            <a href="../vendors.php">
                <button class="btn btn-lg btn-primary mx-4">Place another order</button>
            </a>
            </div>
        </div>
      </div>
