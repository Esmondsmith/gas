...
// }
  ...
  $vend = new Business();
  $vendors = $vend->fetch_all_business();
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-12">
                            ...
                            <h4 style="color: #4676F7; font-weight:bold;">VENDORS LIST</h4>
                        ...
                        <?php foreach($vendors as $vend){ ?>
                            ...
                            <td><?php echo $vend['biz_name']; ?></td>    
                            <td><?php echo $vend['biz_email']; ?></td>
                            <td><?php echo $vend['biz_phone']; ?></td>
                            <td><?php echo $vend['biz_address']; ?></td>
                            <td><?php echo $vend['biz_city']; ?></td>
                            <td><?php echo $type->get_business_type($vend['biz_type_id']); ?></td>
                            <td><?php echo $bizz->get_state_name($vend['biz_state_id']); ?></td>
                            <!-- <td><?php //echo $vend['biz_local_govt_id']; ?></td> -->
                            <td><?php echo $vend['date_registered']; ?></td>

                            <td style="display:flex";>
                            
                            <form action="process/deletebizprocess.php" method="post">
                                <input type="hidden" name="biz_id" value="<?php echo $vend['biz_id']; ?>">
                                ...
                                <a href="editproduct.php?id=<?php// echo $vend['biz_id']; ?>" class='btn btn-md btn-success mx-3'><i class='fa fa-edit'>&nbsp</i> Block</a> -->
                            </td>
                            </tr>
