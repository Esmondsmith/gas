            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../vendors.php">View All Businesses</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <h4 style="color: #4676F7; font-weight:bold;">PRODUCT CATEGORY LIST</h4>
                            </div>
                            </div>
                        ...
                        <?php foreach($category as $cat){ ?>
                            ...
                            <form action="process/cat_deleteprocess.php" method="post">
