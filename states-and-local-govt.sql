...
CREATE TABLE IF NOT EXISTS `lga` (
  `local_govt_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `local_govt_state_id` int NOT NULL DEFAULT '0',
  `local_govt_name` varchar(50) NOT NULL DEFAULT '',
  PRIMARY KEY (`local_govt_id`),
  KEY `local_govt_state_id` (`local_govt_state_id`)
...
INSERT INTO `Local_govt` (`local_govt_id`, `local_govt_state_id`, `local_govt_name`) VALUES
(1, 1, 'Aba North'),
(2, 1, 'Aba South'),
(3, 1, 'Arochukwu'),
(4, 1, 'Bende'),
